@extends('admin-layout.master') @section('title') {{$parking->name}} Parking Lot @endsection @section('content')
<!-- Breadcrumbs-->
<ol class="breadcrumb">
	<li class="breadcrumb-item">
		<a href="/admin-view">Dashboard</a>
	</li>
	<li class="breadcrumb-item active">{{$parking->name}}</li>
</ol>
<div class="row">
	<div class="col-xl-3 col-sm-6 mb-3">
		<div class="card text-white bg-primary">
			<div class="card-body">
				<div class="card-text">{{$parking->name}}</div>
			</div>
	...
	<div class="col-xl-3 col-sm-6 mb-3">
		<div class="card text-white bg-success">
			<div class="card-body">
				<div class="card-text">{{$parking->address}}</div>
			</div>
			<div class="card-footer">
	...
	<div class="col-xl-3 col-sm-6 mb-3">
		<div class="card text-white bg-dark">
			<div class="card-body">
				<div class="card-text"> {{$parking->capacity}}</div>
			</div>
			<div class="card-footer">
